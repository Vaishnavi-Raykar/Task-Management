...
const page = () => {
  return (
    <div>
      <div className="signin-form h-screen w-full flex flex-col justify-center items-center gap-y-7 ">
        <div className="form-group flex flex-col justify-center items-center gap-y-7 bg-purple-700 p-10">
          ...
          <button className="p-3 font-semibold bg-green-600 text-white">Sign In</button>
        </div>
      </div>
    </div>
  );
